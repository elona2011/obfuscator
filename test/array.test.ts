...
import { loopArray, getLoopArr, getArrParam } from '../src/expression/array'
debugger
describe('array', () => {
  it(`len=default`, () => {
    let arr = getLoopArr(),
  ...
  it(`len=4`, () => {
    ...
    expect(arr[param1[0]][param1[1]][param1[2]][param1[3]]).to.equal(arr[param2[0]][param2[1]][param2[2]][param2[3]])
    expect(arr[param3[0]][param3[1]][param3[2]][param3[3]]).to.equal(arr[param4[0]][param4[1]][param4[2]][param4[3]])
    expect(arr[param5[0]][param5[1]][param5[2]][param5[3]]).to.equal(arr[param6[0]][param6[1]][param6[2]][param6[3]])
